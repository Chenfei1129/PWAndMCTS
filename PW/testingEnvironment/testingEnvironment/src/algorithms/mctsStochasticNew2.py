...
class MCTS:
    def __init__(self, numSimulation, selectAction, selectNextState, expand, growNewState, estimateValue, backup, outputDistribution):
        self.numSimulation = numSimulation
        self.selectAction = selectAction 
        self.selectNextState = selectNextState
        self.expand = expand
        self.growNewState = growNewState
    ...
    def __call__(self, currentState):
        ...
        for exploreStep in range(self.numSimulation):
            ...
            while currentNode.isExpanded:
                ...
                #print(actionNode)
                allNextStateNodes = self.growNewState(currentNode, actionNode)
